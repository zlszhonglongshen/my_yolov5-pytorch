...
parser.add_argument('--imgroot', default='/home/data/datasets/VOCdevkit/VOC2012/JPEGImages', help='image directory path')
parser.add_argument('--labroot', default='/home/data/datasets/VOCdevkit/VOC2012/Annotations', help='label directory path')
parser.add_argument('--train_txt', default='/home/data/datasets/VOCdevkit/VOC2012/ImageSets/Main/trainval.txt', help='train.txt')
